...
_SYSTEM = (
    ...
    "shtreimel/spodik. "
    "Archival grain: if beard/payot are soft but the man wears a tall dark Orthodox "
    "hat or shtreimel with dark coat, prefer KEEP (orthodox_fedora/shtreimel) — do not "
    "DROP as 'secular fedora' just because the face is blurry. "
    "Archival group portraits of bearded men in dark fedoras/bowlers/homburgs with "
    "Orthodox look → prefer KEEP (orthodox_fedora), not DROP as secular. "
