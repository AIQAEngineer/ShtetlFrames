...
SETTING_DEFS: dict[str, dict[str, Any]] = {
    ...
    "OPENAI_VERIFY": {
        ...
        "options": ["1", "0"],
        "default": "1",
        "help": "1 = re-check each CLIP hit with OpenAI GPT vision before Review. 0 = CLIP only.",
    ...
    "OPENAI_API_KEY": {
        ...
        "default": "",
        "section": "Vision verify",
        "help": "https://platform.openai.com/api-keys — required when vision second pass is on.",
        "secret": True,
    },
    "OPENAI_MODEL": {
