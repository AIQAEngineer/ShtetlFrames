...
PAGES = {
    ...
    "/swa": "swa.html",
    "/swa.html": "swa.html",
    "/filmhiradok": "filmhiradok.html",
    "/filmhiradok.html": "filmhiradok.html",
    "/fho": "filmhiradok.html",
    "/filmhiradok/processed": "filmhiradok_processed.html",
    "/filmhiradok-processed": "filmhiradok_processed.html",
    "/fho/processed": "filmhiradok_processed.html",
}
...
GET_ROUTES = {
    ...
    "/api/swa/summary": "api_swa:handle_get_summary",
    "/api/swa/queue": "api_swa:handle_get_queue",
    "/api/fho/summary": "api_filmhiradok:handle_get_summary",
    "/api/fho/queue": "api_filmhiradok:handle_get_queue",
...
POST_ROUTES = {
    ...
    "/api/swa/discover": "api_swa:handle_post_discover",
    "/api/swa/scrape": "api_swa:handle_post_scrape",
    "/api/swa/scrape/stop": "api_swa:handle_post_scrape_stop",
    "/api/swa/queue/clear": "api_swa:handle_post_queue_clear",
    "/api/fho/discover": "api_filmhiradok:handle_post_discover",
    "/api/fho/discover/stop": "api_filmhiradok:handle_post_discover_stop",
    "/api/fho/scrape": "api_filmhiradok:handle_post_scrape",
    "/api/fho/scrape/stop": "api_filmhiradok:handle_post_scrape_stop",
    "/api/fho/queue/clear": "api_filmhiradok:handle_post_queue_clear",
